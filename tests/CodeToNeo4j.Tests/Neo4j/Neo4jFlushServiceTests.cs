...
public class Neo4jFlushServiceTests
{
    ...
    {
        _sut = new Neo4jFlushService(_driver, _cypherService, _logger);
    }
    ...
    public async Task GivenSymbolsWithNamespace_WhenFlushSymbolsCalled_ThenUpsertsTags()
    {
        ...
        A.CallTo(() => session.ExecuteWriteAsync(A<Func<IAsyncQueryRunner, Task>>._, A<Action<TransactionConfigBuilder>?>._)).MustHaveHappened(2, Times.Exactly);
    }
