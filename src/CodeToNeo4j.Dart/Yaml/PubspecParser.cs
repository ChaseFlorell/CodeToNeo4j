...
public static class PubspecParser
{
    public static PubspecInfo Parse(string content)
    {
        ...
        var devDependencies = new List<PubspecDependency>();
        ...
        foreach (var line in content.Split('\n'))
        {
            ...
            list.Add(new PubspecDependency(depName, version, isDev));
        }

        return new PubspecInfo(name, dependencies, devDependencies);
    }
}
