...
- **New Issues — Branch Setup**: When starting work on a GitHub issue, create a new branch based off the latest `main`: `git checkout main && git pull && git checkout -b users/CFlorell/story/{issue-number}`. 
